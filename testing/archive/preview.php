<?php
   ...
   define('BTN_SENDARCHIVE', 'Send Archive');
   define('BTN_GOARCHIVE', 'Go to Archive');
...
<html>
   ...
   <body>
      ...
      <form action="preview.php" method="POST">
		 ...
		 <button class='btn btn-primary' type='submit' name='action' value='sendArchive'><?php echo BTN_SENDARCHIVE; ?></button>
		 <a href="archive.php" class="btn btn-primary"><?php echo BTN_GOARCHIVE; ?></a>
