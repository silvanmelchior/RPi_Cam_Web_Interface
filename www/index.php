    ...
    <center>
      ...
      <table border=1 width=650>
        ...
        <tr>
          ...
          <td><input type="text" size=25 id="annotation"><input type="button" value="OK" onclick="send_cmd('an ' + encodeURI(document.getElementById('annotation').value))"><input type="button" value="Default" onclick="document.getElementById('annotation').value = 'RPi Cam %04d.%02d.%02d_%02d:%02d:%02d'; send_cmd('an ' + encodeURI(document.getElementById('annotation').value))"</td>
        </tr>
        <tr>
